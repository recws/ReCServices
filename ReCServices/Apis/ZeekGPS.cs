...
namespace ReCServices.Apis
{
    public static class ZeekGPS
    {
        ...
        public static async void ZeekGPS_ObtenerToken(string UsuarioReC, string Usuario, string Password, string Licencia)
        {            
            try
            {
                auth = await ws.AutentificaUsuarioAsync(Usuario, Password, Licencia);
                ...
                log.Info("WebService ZeekGPS Autenticado: " + UsuarioReC + ". ");
            }
            catch (Exception Ex)
            {
        ...
        public static void ZeekGPS_ObtenerPosicion(string UsuarioReC, string Usuario, string Password, string Licencia)
        {
            ...
            try
            {
                ...
                {
                    ZeekGPS_ObtenerToken(UsuarioReC, Usuario, Password, Licencia);
                    return;
                }
